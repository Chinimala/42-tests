...
You can use valgrind on a test by running directly the a.out generated by yourself : "valgrind ./a.out 85 u" (85 is the test number, u for user ; remove the u for original printf).

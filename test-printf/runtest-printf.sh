...
test "$i - (\"%%*c\", INT_MIN, 'a') : ${NC}" $i 
test "$i - (\"%%*s\", INT_MIN, \"\") : ${NC}" $i 
test "$i - (\"%%1%%\") : ${NC}" $i 
test "$i - (\"%%2%%\") : ${NC}" $i 
test "$i - (\"%%10%%\") : ${NC}" $i 
test "$i - (\"%%1c\", '1') : ${NC}" $i 
...
test "$i - (\"%%10.2%%\") : ${NC}" $i 
test "$i - (\"%%10.10%%\") : ${NC}" $i 
test "$i - (\"%%6.0s\", NULL) : ${NC}" $i 
test "$i - (\"%%6.1s\", NULL) : ${NC}" $i 
test "$i - (\"%%6.2s\", NULL) : ${NC}" $i 
test "$i - (\"%%6.10s\", NULL) : ${NC}" $i 
test "$i - (\"%%7.0s\", NULL) : ${NC}" $i 
test "$i - (\"%%7.1s\", NULL) : ${NC}" $i 
test "$i - (\"%%7.2s\", NULL) : ${NC}" $i 
test "$i - (\"%%7.10s\", NULL) : ${NC}" $i 
test "$i - (\"%%1.0s\", \"\") : ${NC}" $i 
test "$i - (\"%%1.1s\", \"\") : ${NC}" $i 
test "$i - (\"%%1.2s\", \"\") : ${NC}" $i 
test "$i - (\"%%1.10s\", \"\") : ${NC}" $i 
...
test "$i - (\"%%*.*s\", 0, 0, NULL) : ${NC}" $i 
test "$i - (\"%%*.*s\", 0, 0, \"Hello\") : ${NC}" $i 
test "$i - (\"%%*.*s\", 0, 0, NULL) : ${NC}" $i 
test "$i - (\"%%*.*s\", 0, 0, \"Hello\") : ${NC}" $i 
test "$i - (\"%%*.*s\", 0, 0, NULL) : ${NC}" $i 
test "$i - (\"%%*.*s\", 0, 5, \"Hello\") : ${NC}" $i 
test "$i - (\"%%*.*s\", 0, 5, NULL) : ${NC}" $i 
test "$i - (\"%%*.*s\", 0, -5, \"Hello\") : ${NC}" $i 
test "$i - (\"%%*.*s\", 5, 0, NULL) : ${NC}" $i 
test "$i - (\"%%*.*s\", 5, 0, \"Hello\") : ${NC}" $i 
test "$i - (\"%%*.*s\", -5, 0, NULL) : ${NC}" $i 
test "$i - (\"%%*.*s\", -5, 0, \"Hello\") : ${NC}" $i 
test "$i - (\"%%*.*s\", 5, 5, NULL) : ${NC}" $i 
